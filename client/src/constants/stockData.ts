...
export const INITIAL_STOCK_DATA: StockCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Empress Gin', count: 0 },
      { name: 'Violet Liqueur', count: 0 },
      { name: 'Cynar', count: 0 },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Aperol', count: 0 },
      { name: 'Campari', count: 0 },
      { name: 'Limoncello', count: 0 },
      { name: 'Baileys', count: 0 },
    ]
  },
  {
    label: 'Prep',
    items: [
      { name: 'Sangria', count: 0 },
      { name: 'Simple Syrup', count: 0 },
      { name: 'Espresso', count: 0 },
      { name: 'Hibiscus Syrup', count: 0 },
      { name: 'Blueberry Foam', count: 0 },
    ]
  },
  {
    ...
    items: [
      ...
      { name: 'Blood Orange Fever Tree', count: 0 },
      { name: 'Grapefruit Fever Tree', count: 0 },
      { name: 'Tonic Fever Tree', count: 0 },
      { name: 'Apple Juice', count: 0 },
      { name: 'Pineapple Juice', count: 0 },
      { name: 'Grapefruit Juice', count: 0 },
